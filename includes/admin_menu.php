...
function tsml_admin_menu()
{
    ...
    add_submenu_page('edit.php?post_type=tsml_meeting', __('Import, Export, and Settings', '12-step-meeting-list'), __('Import, Export, and Settings', '12-step-meeting-list') . $badge, 'manage_options', 'import', 'tmsl_import_page');
